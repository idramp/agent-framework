...
namespace Streetcred.Sdk.Contracts
{
    ...
    public static class ConnectionServiceExtensions
    {
        ...
        /// <returns>
        /// The negotiating connections async.
        /// </returns>
        public static Task<PagedCollection<ConnectionRecord>> ListNegotiatingConnectionsAsync(
            this IConnectionService connectionService, Wallet wallet, Page page)
            => connectionService.ListAsync(wallet,
                new SearchRecordQuery { { TagConstants.State, ConnectionState.Negotiating.ToString("G") } }, page);
        ...
        /// <param name="page">The page.</param>
        /// <returns>
        /// The connected connections async.
        /// </returns>
        public static Task<PagedCollection<ConnectionRecord>> ListConnectedConnectionsAsync(
            this IConnectionService connectionService, Wallet wallet, Page page)
            => connectionService.ListAsync(wallet,
                new SearchRecordQuery { { TagConstants.State, ConnectionState.Connected.ToString("G") } }, page);
        ...
        /// <param name="page">The page.</param>
        /// <returns>
        /// The invited connections async.
        /// </returns>
        public static Task<PagedCollection<ConnectionRecord>> ListInvitedConnectionsAsync(
            this IConnectionService connectionService, Wallet wallet, Page page)
            => connectionService.ListAsync(wallet,
                new SearchRecordQuery { { TagConstants.State, ConnectionState.Invited.ToString("G") } }, page);
    }
}