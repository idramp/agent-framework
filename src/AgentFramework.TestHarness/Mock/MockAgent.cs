...
namespace AgentFramework.TestHarness.Mock
{
    public class MockAgent : AgentMessageProcessorBase
    {
        ...
        public Task<byte[]> HandleInboundAsync(MessageContext messageContext, IServiceProvider serviceProvider) => ProcessAsync(Context, messageContext, serviceProvider);
