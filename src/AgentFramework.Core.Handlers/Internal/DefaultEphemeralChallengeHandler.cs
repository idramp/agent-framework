...
namespace AgentFramework.Core.Handlers.Internal
{
    internal class DefaultEphemeralChallengeHandler : MessageHandlerBase<EphemeralChallengeResponseMessage>
    {
        ...
        protected override async Task<AgentMessage> ProcessAsync(EphemeralChallengeResponseMessage message, IAgentContext agentContext, MessageContext messageContext, System.IServiceProvider serviceProvider)
        {
