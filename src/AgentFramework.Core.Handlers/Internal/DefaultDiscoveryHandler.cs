...
namespace AgentFramework.Core.Handlers.Internal
{
    ...
    internal class DefaultDiscoveryHandler : MessageHandlerBase<DiscoveryQueryMessage>
    {
        ...
        protected override Task<AgentMessage> ProcessAsync(DiscoveryQueryMessage message, IAgentContext agentContext, MessageContext messageContext, System.IServiceProvider serviceProvider)
        {
